...
The goal is to make the choices in FOTD "interesting." To show what this means, I use Slay the Spire as an example; in particular, I mean the choices of 1-out-of-3 cards to add to your deck. The testament that these choices are interesting is that quite often, a player who is very good at the game (for example, joiNrbs) will pause and think about which of 3 cards to pick, often giving reasons and counter-reasons to defend his/her decision, in a place where less skilled players would pick the card automatically with a less nuanced heuristic.

Note that for a game to be interesting, it is not important for every situation, or even many situations, to be interesting -- usually, the right move in Poker (a pretty interesting game) is simply folding and ending the game -- as long as that *at least once in a while* the situation is different enough to warrant thinking. What gives Slay the Spire even more points is that even the less tactically-interesting portion, the actual playing of the cards in the deck, is "interesting" by this definition.

An idealized example that reflects an interesting choice in the battle layer of FOTD (which is representative of the strategic layer, both being simultaneous-turn) is:

Visualization: [context: Attacking < Defending < Indirect Tactics < Attacking] you are deadlocked in an important battle. It is a rainy day, and the enemy has a slight army advantage, so Attacking is a good choice for the enemy. You do not have the Flood skill ready this turn (which you can activate if you pick Defense and the enemy picks Attack to do massive damage on rainy days). However, you know that the enemy is very likely to not attack because you used Flood previously and the AI knows it is raining, so the AI is likely to value Defending higher than Attacking. You decide the AI will never consider Attacking, so you use Indirect Attack. Indeed, the AI Defends, and you do free damage using your Indirect Attack.

What will (hopefully) make this much more interesting than straight rock-paper-scissors (which already has quite a bit of complexity when it comes to humans) is the different conditions (weather, available tactics, available tactics to the opponents) that offer a lot of variety, and synergizes well with the diverse officer abilities and skills, with the structural goal that each potential battle condition be something that can change a good player's decision in a nontrivial fraction of the situation space. 

I now address the 3 flaws mentioned, inspired by other games (it's particularly exciting that some games/genres offer design choices that attack multiple angles at once). At the end of each section is a mantra that I would like to apply (as a type of mission statement) and a visualization of how I envision something to play out in the game.
...
My mantra to myself is: *every once in a while, the player should find him/herself in a unique situation, both for tactical decisionmaking (1) and for appreciating the world (2).*
...
This leads to a solution which I think is extremely underutilized, and that is to explain the AI's thinking process. We often treat the AI as a black box, but if we can have it explain its thinking on why it made a move, it would make you feel that you just won (or lost) against a real opponent. What better genre to do that than in a strategy game where we have colorful dialogues of officers? (For chess developers: I personally think it would be amazing if a chess AI would just say something like "if you make that move it would destroy the use of your queen" rather than "if you move that way my probability of winning goes up to 61%;" this is a meta - machine learning problem, where the output features are human descriptions and the input features are neural network decisions)

By the way, the simultaneous-turn structure makes the game feel more "fair" (and thus have more semblance of AI) and adds the important elements of bluffing instead of simply reacting to information. This is another plus point of the proposed design.
